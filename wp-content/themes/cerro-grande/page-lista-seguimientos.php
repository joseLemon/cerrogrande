    ...
    <div class="wrapper">
        <div class="container request-list spacing">
            ...
            if ( $flag ) {
                ...
                $inProcess = $wpdb->get_results("SELECT follow_up_id, user_id, subject, solicitor_name, last_name, m_last_name, social_reason, statuses.name as status_name FROM follow_ups INNER JOIN statuses on follow_ups.status_id = statuses.status_id WHERE follow_ups.status_id = 1 LIMIT ".$pageR.", 15");
                $inProcessCount = $wpdb->get_results("SELECT COUNT(follow_up_id)as cont FROM follow_ups WHERE follow_ups.status_id = 1");
                $paused = $wpdb->get_results("SELECT follow_up_id, user_id, subject, solicitor_name, last_name, m_last_name, social_reason, statuses.name as status_name FROM follow_ups INNER JOIN statuses on follow_ups.status_id = statuses.status_id WHERE follow_ups.status_id = 2 LIMIT ".$pagePa.", 15");
                $pausedCount = $wpdb->get_results("SELECT COUNT(follow_up_id)as cont FROM follow_ups WHERE follow_ups.status_id = 2");
                $concluded = $wpdb->get_results("SELECT follow_up_id, user_id, subject, solicitor_name, last_name, m_last_name, social_reason, statuses.name as status_name FROM follow_ups INNER JOIN statuses on follow_ups.status_id = statuses.status_id WHERE follow_ups.status_id = 3 LIMIT ".$pageC.", 15");
                $concludedCount = $wpdb->get_results("SELECT COUNT(follow_up_id)as cont FROM follow_ups WHERE follow_ups.status_id = 3");
            }
            ?>
