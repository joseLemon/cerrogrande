            ...
            <ul class="nav navbar-nav">
                ...
                <?php } else if(current_user_can('administrator')) { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo home_url().'/';?>registro">Registrar Solicitud</a></li>
                            <li><a href="<?php echo home_url().'/';?>registro-usuario">Registrar Usuario</a></li>
                            <li><a href="<?php echo home_url().'/';?>lista-seguimientos">Lista de Seguimientos</a></li>
                            <li><a href="<?php echo wp_logout_url(home_url()); ?>">Cerrar Sesión</a></li>
                        </ul>
                    </li>
                <?php } else if( current_user_can('editor')) { ?>
                    <li class="dropdown">
                ...
                <?php } else { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo home_url().'/';?>mi-cuenta"><?php echo $solicitudes; ?></a></li>
